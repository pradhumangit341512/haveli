...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${env.siteUrl}/virtual-tour` },
};
...
export default function VirtualTourPage() {
  const tourSpots = [
    ...
    { name: "Banquet Hall", image: "https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=800&q=85", description: "Elegant space for weddings, events, and celebrations" },
