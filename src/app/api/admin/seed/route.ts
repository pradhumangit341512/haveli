...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (existingRooms === 0) {
      ...
      // Floor 3: 4 Royal Deluxe + 1 Maharaja Suite
      for (let i = 1; i <= 4; i++) {
        roomData.push({
      ...
      // Floor 4: 3 Maharaja Suites + 1 Family Suite
      for (let i = 1; i <= 3; i++) {
        roomData.push({
      ...
      roomData.push({
        ...
        status: "available",
        housekeeping: "clean",
        notes: "Terrace garden access",
        createdAt: new Date(),
      });
      // Floor 5: 2 Family Suites (rooftop level)
      for (let i = 1; i <= 2; i++) {
        roomData.push({
    ...
    if (existingBookings === 0) {
      await bookings.insertMany([
        ...
        { name: "Priya Agarwal", phone: "+91 87654 32109", email: "priya@example.com", checkin: "2025-04-10", checkout: "2025-04-15", room: "Maharaja Suite", roomNumber: "305", guests: "2 Adults + 1 Child", message: "Honeymoon trip, cake arrangement", status: "confirmed", source: "WhatsApp", totalAmount: 40000, notes: "VIP guest", createdAt: new Date("2025-03-27") },
        { name: "Vikram Singh", phone: "+91 76543 21098", email: "", checkin: "2025-05-01", checkout: "2025-05-03", room: "Family Suite", roomNumber: "404", guests: "2 Adults + 2 Children", message: "", status: "pending", source: "MakeMyTrip", totalAmount: 20000, notes: "", createdAt: new Date("2025-03-26") },
        ...
        { name: "Arjun Patel", phone: "+91 88776 65544", email: "arjun@example.com", checkin: "2025-03-25", checkout: "2025-03-27", room: "Maharaja Suite", roomNumber: "401", guests: "2 Adults", message: "", status: "checked_out", source: "Booking.com", totalAmount: 16000, notes: "Repeat guest", createdAt: new Date("2025-03-20") },
      ]);
    }
