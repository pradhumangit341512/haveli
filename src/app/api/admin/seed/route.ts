  ...
  try {
    ...
    if (existingBookings === 0) {
      await bookings.insertMany([
        { name: "Rahul Sharma", phone: "+91 98765 43210", email: "rahul@example.com", checkin: "2025-04-01", checkout: "2025-04-03", room: "Royal Deluxe", roomNumber: "101", guests: "2 Adults", message: "Early check-in requested", status: "confirmed", source: "Direct", totalAmount: 10000, notes: "", createdAt: new Date("2025-03-28") },
