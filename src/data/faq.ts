...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Patrika Gate (5 km), Hawa Mahal (12 km), City Palace (13 km), Jal Mahal (16 km), Amber Fort (22 km), Sanganer Block Printing workshops (2 km), and Sitapura EPIP business zone (4 km). Our travel desk arranges daily sightseeing tours.",
  },
  {
    question: "Does the hotel offer free Wi-Fi and parking?",
    answer: "Yes, complimentary high-speed Wi-Fi in all rooms and public areas. Free secure parking for all guests. Dedicated work desks in every room for business travelers.",
  },
  {
    question: "Is the hotel good for corporate and business stays?",
    answer: "Yes, we offer corporate rate packages for travelers visiting Sitapura EPIP, JECC Convention Centre, and Jaipur's southern business corridor. Monthly billing, long-stay discounts, and meeting space available.",
  },
  {
    question: "What is the cancellation policy?",
    answer: "Free cancellation up to 24 hours before check-in for most room types. Non-refundable rates available at discounted prices. Group bookings have specific terms discussed during reservation.",
  },
  {
