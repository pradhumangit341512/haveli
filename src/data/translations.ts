...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    hero: {
      badge1: "A Heritage Hotel",
      badge2: "At The Airport, Jaipur",
      title: "A Heritage Hotel Near",
      titleEm: "Jaipur Airport",
      description: "21 exquisitely crafted royal rooms with rooftop dining overlooking Jaipur Airport and the timeless Aravallis. Heritage hospitality in Sanganer, near Terminal 1 Airport, Jaipur.",
    ...
    about: {
      ...
      titleEm: "Sanganer, Jaipur",
      description1: "Rising majestically in Krishi Nagar, Sanganer, The Ummed Haveli is a five-story architectural marvel inspired by Rajasthan's timeless haveli tradition.",
      description2: "Located near Terminal 1 Airport in Sanganer, our 21 luxury rooms offer the perfect confluence of heritage aesthetics and five-star modern comfort.",
    ...
    contact: {
      ...
      titleEm: "The Ummed Haveli Jaipur",
    ...
    footer: {
      tagline: "A Heritage Hotel At The Airport",
