...
export const offers: Offer[] = [
  {
    ...
    includes: [
      ...
      "Couple photoshoot at hotel (30 min)",
    ],
    validUntil: "2025-12-31",
    image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?w=800&q=80",
    imageAlt: "Honeymoon suite at The Shekhawat Haveli Jaipur with romantic decoration",
    badge: "Most Popular",
  ...
  },
  {
    ...
    description: "Planning a destination wedding in Jaipur? Block 10 or more rooms and get exclusive group rates, coordinated airport transfers, and dedicated wedding liaison to handle all guest logistics.",
    price: "Rs 4,000/room/night",
    originalPrice: "Rs 5,000/room/night",
    discount: "20% Off",
    includes: [
      "Group rate: Rs 4,000/room/night (min 10 rooms)",
      "Coordinated group airport transfers",
      "Dedicated wedding guest coordinator",
      "Decorated welcome lobby for wedding party",
      "Customized room assignments",
      "Group breakfast arrangement",
      "Late checkout for wedding night guests",
      "Complimentary meeting room for coordination",
    ],
    validUntil: "2025-12-31",
    image: "https://images.unsplash.com/photo-1605649487212-47bdab064df7?w=800&q=80",
    imageAlt: "Wedding group accommodation at The Shekhawat Haveli Jaipur",
  ...
  },
  {
    ...
    includes: [
      ...
      "Daily laundry: 3 pieces/day",
      "Airport transfer on arrival & departure",
      "Access to meeting room (2 hrs/day)",
      "Monthly billing available",
    ],
    validUntil: "2025-12-31",
    image: "https://images.unsplash.com/photo-1566665797739-1674de7a421a?w=800&q=80",
    imageAlt: "Corporate room with work desk at The Shekhawat Haveli Jaipur",
    badge: "Best Value",
  ...
  },
  {
    ...
    includes: [
      ...
      "Complimentary airport/station pickup",
